# conda create -n opentims python=3.9
# conda activate opentims
# pip install timspy
# pip install vaex-core vaex-hdf5 h5py
# /Users/adams/opt/miniconda3/envs/opentims/bin/python3
...
path = pathlib.Path('/Users/adams/Projects/300K/20220613-library-test/raw ')
