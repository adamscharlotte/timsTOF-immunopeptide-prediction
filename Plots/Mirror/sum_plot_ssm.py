...
query_filename = base_path + "precursor-consensus/annotated-mgf/" + pool + ".mgf"
...
name_plot = pool + "_" + precursor_1 + "_" + precursor_2 + "_" + charge + "_" + sequence #[UNIMOD:121]    [UNIMOD:21]    [UNIMOD:21#g1]	[-28.031300]
txt = 'm/z'
