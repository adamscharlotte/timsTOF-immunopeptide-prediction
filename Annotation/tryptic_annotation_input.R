...
raw_path <- paste(base_path, "Analysis/", pool, "_01_01/TIMS-30min-R1-TIMS_semitryptic/230719_f1-", pool, "_01_01-TIMS-30min-R1.d", sep = "") # nolint
txt_path <- paste(base_path, "External_data/Bruker/UA-TimsTOF-300K/TUM-Searches/", pool, "/combined/txt/", sep = "") # nolint
setwd(txt_path)
...
output_path <- paste(base_path, "External_data/Bruker/UA-TimsTOF-300K/Annotation/precursor-mapped/", pool, ".csv", sep = "") # nolint
