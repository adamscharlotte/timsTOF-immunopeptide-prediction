...
f = open("/media/kusterlab/internal_projects/active/ProteomeTools/ProteomeTools/External_data/Bruker/UA-TimsTOF-300K/Annotation/tryptic-frames.csv", "a")
f.write(f"{pool}, {min_frame}, {max_frame}" + '\n')
f.close()